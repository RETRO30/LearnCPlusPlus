// В текстовом файле записан русский текст.
// Найти в тексте слова, содержащие две одинаковые буквы подряд,
// записать их в верхнем регистре и указать после каждого такого слова в скобках найденные буквы. Полученный текст записать в тот же файл.
